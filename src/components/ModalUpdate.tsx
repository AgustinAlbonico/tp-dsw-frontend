...
function ModalUpdate({ editData , editCancha , setShowModal }) {
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <form className="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 w-full" onSubmit={onSubmit}>
                    ...
                    <select className="shadow border rounded w-full py-2 px-1 text-black bg-white" name='tipo' onChange={handleChange} value={formData.tipo}>
                    ...
                    <select className="shadow border rounded w-full py-2 px-1 text-black bg-white" name='zona' onChange={handleChange} value={formData.zona}>
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" name='nro_calle' onChange={handleChange} value={formData.nro_calle}/>
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" name='costo' onChange={handleChange} value={formData.costo}/>
